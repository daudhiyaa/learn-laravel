<x-layout>
    ...
    <div class="py-4 px-4 mx-auto max-w-screen-xl lg:px-6">
        <div class="mx-auto max-w-screen-md sm:text-center">
            <form action="/blog" method="GET"> {{-- defaultnya emang dibalikin ke page yg sama ('blog') & default method emg 'GET' --}}
                @if (request('category'))
                ...
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        ...
                        <input
                            ...
                            placeholder="Search by title" type="search" id="search" name="search"
                            autocomplete="off">
                    </div>
                    <div>
                        <button type="submit"
        ...
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                <article
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex items-center space-x-4">
                            ...
                            <a href="/blog?author={{ $blog->author->username }}"
            ...
            @empty
                <span class="flex flex-col">
                    <p class="text-3xl text-red-500">Article Not Found !</p>
                    <a href="/blog" class="text-blue-500 hover:underline">&laquo; Back to All Blogs</a>
                </span>
            @endforelse
